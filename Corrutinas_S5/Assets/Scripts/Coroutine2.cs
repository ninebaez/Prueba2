...

{
    ...
    private IEnumerator AsignarColor()
    {
        ...
        players[0].GetComponent<Renderer>().material.color = UnityEngine.Color.green;
        players[1].GetComponent<Renderer>().material.color = UnityEngine.Color.red;
        players[2].GetComponent<Renderer>().material.color = UnityEngine.Color.yellow;
        players[3].GetComponent<Renderer>().material.color = UnityEngine.Color.black;
        players[4].GetComponent<Renderer>().material.color = UnityEngine.Color.blue;
